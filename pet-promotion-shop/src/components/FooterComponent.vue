<template>
  <footer class="bg-gray-50">
    ...
    >
      <div class="max-w-sm">
        ...
        <div class="text-gray-500 mt-12">
          Creating a harmonious and thriving community of happy and healthy pets
          and pet owners.
        </div>
        <div class="flex pl-0 space-x-6 sm:justify-center md:mt-10">
          <a
            href="#"
            class="text-gray-400 hover:text-gray-900 dark:hover:text-blue-950"
          >
            <svg
              class="w-7 h-7"
              fill="currentColor"
    ...
    <div class="bg-gray-100">
      ...
      >
        <div class="">© 2023 Paws | All Rights Reserved</div>
      </div>
    </div>
  </footer>
</template>
